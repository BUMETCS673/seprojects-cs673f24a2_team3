...
# Add the BASE_DIR to the Python path
...
# Updated Template Files Configuration


TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS':  [os.path.join(BASE_DIR, 'analysis', 'templates')],  # Add the path to our templates # New templates location
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# STATIC_URL = 'static/'
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "analysis",'static')]  # New static files location
